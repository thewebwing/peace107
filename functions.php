...
function peace107_widgets_init() {
    ...
    register_widget('Peace_Widget_Morning_Verse');
}
...
function peace107_scripts() {
    ...
    //wp_enqueue_script('dfp', get_stylesheet_directory_uri() . '/js/dfp.js', array('jquery'), false, true);
